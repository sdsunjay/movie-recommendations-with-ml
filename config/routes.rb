Rails.application.routes.draw do
  ...
  devise_scope :user do
    ...
    authenticated :user do
      ...
      resources :lists, only: [:index, :show, :new, :create, :edit, :destroy, :update] do
        resources :movie_lists, only: [:new, :create, :destroy]
      end
      ...
      resources :genres, only: [:show, :index, :edit, :destroy, :update]
